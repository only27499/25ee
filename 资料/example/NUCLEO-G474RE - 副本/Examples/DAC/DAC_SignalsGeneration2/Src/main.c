...
DMA_HandleTypeDef hdma_dac1_ch2;//xcz
...
uint16_t sinewave[60] = {
0x07ff,0x08a9,0x094f,0x09f3,0x0a90,0x0b26,0x0bb3,0x0c37,0x0cae,0x0d18,0x0d74,0x0dc0,0x0dfd,0x0e28,0x0e42,0x0e4c,
0x0cdd,0x0e28,0x0dfd,0x0dc0,0x0d8a,0x0d18,0x0cae,0x0c37,0x0bb3,0x0b26,0x0a90,0x09f3,0x094f,0x08a9,0x0801,0x0758,
0x06b2,0x0690,0x0650,0x0600,0x0580,0x0578,0x0540,0x04ff,0x04aa,0x0472,0x0430,0x0400,0x037e,0x033a,0x037e,0x0400,
0x0430,0x0472,0x04aa,0x04ff,0x0540,0x0578,0x0580,0x0600,0x0650,0x0690,0x06b2,0x0733};
//uint16_t sinewave[60] = {
...
//0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,
//0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,
//0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd,0x0cdd};
...
int main(void)
{
  ...
  MX_GPIO_Init();//__HAL_RCC_GPIOA_CLK_ENABLE()
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.PLL.PLLM = RCC_PLLM_DIV4;//4MHz
  RCC_OscInitStruct.PLL.PLLN = 75;//4 * 75 = 300MHz
  RCC_OscInitStruct.PLL.PLLP = RCC_PLLP_DIV2;
  RCC_OscInitStruct.PLL.PLLQ = RCC_PLLQ_DIV2;
  RCC_OscInitStruct.PLL.PLLR = RCC_PLLR_DIV2;//150MHz
  ...
  */
  ...
  RCC_ClkInitStruct.SYSCLKSource = RCC_SYSCLKSOURCE_PLLCLK;//150MHz
...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = 149;//1MHz--1us(149)
  htim2.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim2.Init.Period = 999;//1ms---1KHz(999)
  htim2.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;//150MHz
...
static void MX_TIM6_Init(void)
{
  ...
  htim6.Instance = TIM6;
  htim6.Init.Prescaler = 0;//150MHz(0)
  htim6.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim6.Init.Period = 4;//16us-----60KHz(2499)
...
//  sDacConfig.DAC_Trigger2 = tmp;
  ...
  sDacConfig.DAC_Trigger2 = DAC_TRIGGER_NONE;
